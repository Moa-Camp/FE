...
import CourseTable from "@/components/bootcamp/CourseTable";
import FilterSidebar from "@/components/bootcamp/FilterSidebar";
...
const BootCamp = () => {
    const data = getListPage("pages/bootcamp.md");
