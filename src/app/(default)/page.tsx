...
interface HomePage {
  banner: { title: string; image: string; content?: string; link?: Button };
  brands: Array<string>;
  features: {
    sub_title: string;
    title: string;
...
const Home = () => {
  ...
  const { banner, brands, features, intro, service }: HomePage = frontmatter;
  ...
  return (
    <>
          ...
          <div className="container relative">
            <div className="row text-center">
              <div className="col-12">
                <div
                  className="row relative z-10 justify-center px-7 pb-10 pt-20 2xl:px-48"
                  data-aos="fade-up"
                >
                  <div
                    className="rellax -z-10 px-0 lg:col-10 xl:px-6"
                    data-rellax-speed="-3"
                  >
                    <h1
                      className="md:text-h2-md mb-12 text-center text-h2-sm font-semibold lg:text-h2"
                      data-aos="fade-up"
                ...
                <div className="has-circle bg-primary/5">
                  <Circle
                    classes={"top-[50px] left-[11%] ratio-32 rellax rellax"}
                    rellax="-2"
                  />

                  <Circle
                    classes={"top-[29%] left-[3%] ratio-85 fill rellax"}
                    rellax="2"
                  />
                  <Circle classes={"top-[45%] left-[22%] ratio-20 fill"} />
                  <Circle
                    classes={"bottom-[35%] left-[15%] ratio-47 rellax"}
                    rellax="1"
                  />
                  <Circle
                    classes={"bottom-[8%] left-[6%] ratio-62 rellax"}
                    rellax="-1"
                  />
                  <Circle
                    classes={"top-[100px] right-[12%] ratio-20 fill rellax"}
                    rellax="-0.5"
                  />
                  <Circle
                    classes={"top-[30%] right-[2%] ratio-73 rellax"}
                    rellax="-1"
                  />
                  <Circle
                    classes={"top-[52%] right-[19%] ratio-37 rellax"}
                    rellax="-0.5"
                  />
                  <Circle
                    classes={"top-[55%] right-[33%] ratio-20 fill rellax"}
                    rellax="1"
                  />
                  <Circle
                    classes={"bottom-[20%] right-[5%] ratio-65 fill rellax"}
                    rellax="-2"
                  />
                  <svg
                    className="text-primary opacity-[0.14]"
                    width="100%"
                    height="90%"
                    viewBox="0 0 1397 502"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      d="M2 501C35.0836 398.787 165.889 212.869 424.439 286.903c323.189 92.542 463.337-26.012 519.197-131.059C999.496 50.796 1146.13-47.2484 1396 29.2863"
                      stroke="currentcolor"
                      strokeOpacity=".85"
                      strokeWidth="4"
                  ...
                  <svg
                    className="absolute right-0 top-0 hidden text-primary opacity-[0.14] lg:block"
                    width="740"
                    height="525"
                    viewBox="0 0 786 555"
                    fill="none"
      ...
      <section className="mt-14 pb-8">
        <div className="overflow-hidden">
          <div className="container">
            <div className="row">
              <div
                className="animate from-right md:col-12"
                data-aos="fade-right"
              >
      ...
      */}
          ...
          <div className="row">
            <div className="col-md-12 text-center" data-aos="fed-up">
              <div className="section-title">
                <p
                  dangerouslySetInnerHTML={markdownify(features.sub_title)}
                ...
                />
                <p
                  dangerouslySetInnerHTML={markdownify(features.description!)}
                  className="text-[.9rem] text-text"
                />
              </div>
              <FeatureSlider slides={features.list} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* <Testimonials data={testimonial.frontmatter} /> */}
      {/* <CallToAction /> */}
      <BannerSlider/>
